...
void bmSound_802D112C(VehicleData*);
void bmSound_802D12C4(VehicleData*);
void bmSound_802D1320(VehicleData*);
void bmSound_802D1334(VehicleData*);
void bmSound_802D1534(VehicleData*);

void bmSoundInit(VehicleData* arg0) {
    arg0->unk41C = 0.0f;
    D_80359648.unk0 = 4;
    D_80359648.unk4 = 0;
...
void bmSound_802D112C(VehicleData* arg0) {
...
void bmSound_802D12C4(VehicleData* arg0) {
    arg0->unk410 |= 1;
    func_8033F904(arg0->unk414, 1.0f, 0.0f, 0.0f);
    func_8033F904(arg0->unk415, 1.0f, 0.0f, 0.0f);
}

void bmSound_802D1320(VehicleData* arg0) {
    arg0->unk410 &= 0xFFFFFFFE;
}

void bmSound_802D1334(VehicleData* arg0) {
    f32 temp_fv1;
    s32 i;
...
void bmSound_802D1534(VehicleData* arg0) {
